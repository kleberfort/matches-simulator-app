package fort.kleber.simulator.ui.adapter;
...
import fort.kleber.simulator.databinding.MatchItemBinding;
import fort.kleber.simulator.domain.Match;
import fort.kleber.simulator.ui.DetailActivity;
...
public class MatchesAdapter extends RecyclerView.Adapter<MatchesAdapter.ViewHolder> {
    ...
    public int getItemCount() {
        return matches.size(); // tamanho da lista vinda da minha lista
    }
