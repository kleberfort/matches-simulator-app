package fort.kleber.simulator.ui;
...
import fort.kleber.simulator.R;
import fort.kleber.simulator.data.MatchesApi;
import fort.kleber.simulator.databinding.ActivityMainBinding;
import fort.kleber.simulator.domain.Match;
import fort.kleber.simulator.ui.adapter.MatchesAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://kleberfort.github.io/matches-simulator-api/")
